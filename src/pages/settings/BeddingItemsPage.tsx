...
export default function BeddingItemsPage() {
  const items = useLiveQuery(
    () => db.beddingItems.orderBy('sortOrder').toArray()
  );
  ...
  const saveEdit = async () => {
    ...
    await db.beddingItems.update(editingId, { name: editName.trim() });
    setEditingId(null);
  };
